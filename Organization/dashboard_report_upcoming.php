 <?php  
  ...
  $query = "SELECT * FROM event WHERE event_status = 'Upcoming' AND user_id = ".$id."";

  $data = mysqli_query($sql,$query);
  if(!$data){
    echo "ERROR IN REPORT UPCOMING";
  }
 ...
 <html>  
      <head>  
           <title>Upcoming Event | Reports</title>  
      ...
      <body>  
        <br/>
           ...
           <br/>
              <h3><b>Upcoming Event</b>  |   Report <br></h3>  
                <br/>  
