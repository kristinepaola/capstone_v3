...
//EVENT ADVOCACY
$advo_query = "SELECT * FROM event_advocacy WHERE event_id =$id";
$advo_data = mysqli_query($sql, $advo_query);
if(!$advo_data){
	"ERROR IN QUERY";
}
$advo_row = mysqli_fetch_array($advo_data);
						...
						<form action="updateEvent.php" method="POST" enctype="multipart/form-data">
									...
									<div class="clear">
										<div class="col-sm-6">
											<div class="form-group col-sm-12">
												<label>Image *</label>
												<input name="event_img" type="file" id="event_img">
												<?php echo "<img src=../admin/eventImages/".$event_row['event_img'].">";?>
											</div>
											<div class="form-group col-sm-12" >
												<label>Event Title *</small></label>
												<input required name="event_name" type="text" id="event_name" class="form-control" value="<?php echo $row['event_name'];?>">
											</div> 
											<div class="form-group col-sm-12">
												...
												<textarea required name="event_description" id="event_description" class="form-control"><?php echo $row['event_description'];?></textarea>
											</div> 
										</div>
										<div class="col-sm-6">
											<div class="form-group col-sm-12">
												<label>Location *</label>
												<input required name="event_location" type="text" id="event_location" class="form-control" value="<?php echo $row['event_location'];?>">
											</div> 
											<div class="form-group col-sm-12">
												<div id="map"></div>
											</div>
									...
									<div class="col-sm-6">
											...
											<div class="form-group col-sm-12">
												...
												<textarea rows ="5" name="event_material_req" type="text" id="event_material_req" class="form-control" required><?php echo $row['event_material_req'];?></textarea>
											</div>
										...
										<div class="col-sm-6">
											<div id="container">
												...
												<?php
												$query="SELECT * FROM occupation_event WHERE event_id = '$id'";
												...
												echo '<div class="form-group col-sm-12">
														<div class="form-group col-sm-3">
															<label>Qty </label>
															<input name="no_volunteer[]" type="number" id="no_volunteer_1" class="form-control" value="'.$row['noVolunteers'].'">
														</div>
															...
															<select name="occupation_name[]" class="form-control">
																...
																<option>No Occupation Required</option>';
																	...
																	while ($occ_row = mysqli_fetch_array($occupation_data)){
																		if($row['occupationName']==$occ_row['occupation_name']){
																			echo "<option selected>".$occ_row['occupation_name']."</option>";
																		}else{
									...
									<div class="form-group col-sm-12">
										<div class="col-sm-10 col-sm-offset-1">
											<input type='submit' class='btn btn-finish btn-primary pull-right' name='submit' value='Update' id='submit'/>
										</div>	
									</div>
					</div>
						</form>					
