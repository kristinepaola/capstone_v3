						...
						<?php 
							while($row=mysqli_fetch_array($follow_data)){
								...
								if ($follower == ""){
									...
									echo "<label>".$row['first_name']."</label>";
									echo '</div>';
								}else{
					...
					success:function(retval){
						...
						for(var i = 0; i<retval.length; i++){
							if (retval[i].user_prof_pic == ""){
								img_icon = '<div class="col-xs-3 col-sm-3"><a href="volunteerProfile.php?id='+retval[i].volunteer_id+'"><img src="../admin/default.gif" class="prof_pic_icon"><p>'+retval[i].first_name+'</p></div>';
							}else{
								var img_icon = '<div class="col-xs-3 col-sm-3"><a href="volunteerProfile.php?id='+retval[i].volunteer_id+'"><img src="../admin/userProfPic/'+retval[i].user_prof_pic+'" class="prof_pic_icon"></a><p>'+retval[i].first_name+'</p></div>';
							}
