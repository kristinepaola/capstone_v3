<?php
	...
	$org_id = $_GET['id'];
	$query = "SELECT * FROM event WHERE event_status = 'Upcoming' AND user_id = '$org_id' ORDER BY event_start DESC";
	...
	$page_first_result = ($page-1)*$result_per_page;
	 ...
	 $page_query = "SELECT * FROM event WHERE event_status = 'Upcoming' AND user_id = '$org_id' ORDER BY event_start DESC LIMIT ".$page_first_result.", ".$result_per_page."";
