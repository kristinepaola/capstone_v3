...
<body class="hold-transition skin-white layout-top-nav" onload="viewData()">
  <div class="content-wrapper">
    <section class="container">
      <h1>Lists of Volunteers <div class="pull-right"><a href="admin_dashboard.php" class="btn btn-info">
   ...
   <!-- <div class="form-group">
    <div class="input-group">
     ...
     <input type="text" name="search_text" id="search_text" placeholder="Search Volunteers" class="form-control" />
    </div>
   </div> -->
      <div class="row">
        <div class="col-xl-8">
