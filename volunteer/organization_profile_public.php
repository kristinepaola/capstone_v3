 <?php
	...
	//display org_details
	$orgdet_query ="SELECT * FROM organization_details WHERE user_id=".$id."";
    $orgdet_data = mysqli_query($sql, $orgdet_query);
      if(!$orgdet_data){
        echo "ERROR IN QUERY";
      }
      $orgdet_row = mysqli_fetch_array($orgdet_data);
  ...
  <div class="banner-color">
    <div class="col-md-12">  
     <div class="col-md-8"> 
        ...
        <h2>Welcome <strong><?php echo $org_row['first_name']; ?></strong></h2>

       <!--  Organization's logo -->
       <div class="col-md-4" id="">
		
           <?php 
		   $org_img = $org_row['user_prof_pic'];
		   $img_src = "../admin/userProfPic/".$org_img;
		   echo "<img src='".$img_src."' class='prof_pic_logo'>"; ?>
       ...
       <!--  //advocacies -->
        ...
        <div class="col-md-4">
            ...
            <?php echo $orgdet_row['organization_mission'];?>
            <h3><strong>Vision</strong></h3>
            <?php echo $orgdet_row['organization_vision'];?>
        </div>
   </div>
</div>
