                            ...
                            <?php 
                              while($org=mysqli_fetch_array($followlimit_data)){
                                ...
                                echo '    <div class="col-xs-4 col-sm-4 ">
                                          <a href="../Organization/organization_profile_public.php?id='.$org['org_id'].'"><img src="'.$img_src.'" class="following_icon" class="following_icon"></a>
                                          <a href="../Organizationorganization_profile_public.php?id='.$org['org_id'].'"> '.$orgname_row['first_name'].'</a><br>
                                          </div>
