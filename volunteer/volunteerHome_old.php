...
<!-- READ MORE MODAL! -->
			...
			<!-- END OF ALERT MODAL -->
			<!-- END OF MISSED MODAL -->
			<div id="missed_modal" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
			  <div class="modal-dialog modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title">Missed Activities</h4>
					</div>
					<div class="modal-body">
...
var x = $.ajax({
	...
	success:function(retval){
		...
		for(var i=0; i<retval.length; i++){
			 rowstr = "<tr><td>"+retval[i].event_name+"</td>";
			 rowstr += "<td>"+retval[i].event_start+"</td>";
			 $("#table-target").append(rowstr);
		}
		
		$("#missed_modal").modal("show");
	}
